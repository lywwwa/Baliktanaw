...
public class Test : MonoBehaviour
{
	...
	//public void SetInactiveDialogue()
	//{
	//	d_Datu[0].SetActive(false);
	//	d_Datu[1].SetActive(false);
	//	d_Datu[2].SetActive(false);
	//	d_Datu[3].SetActive(false);
	//	d_Datu[4].SetActive(false);
	//	d_Datu[5].SetActive(false);
	//	d_Datu[6].SetActive(false);
	//	d_Datu[7].SetActive(false);
	//	d_Datu[8].SetActive(false);
	//	d_Datu[9].SetActive(false);
	//}
}
